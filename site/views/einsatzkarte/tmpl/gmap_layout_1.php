...
<?php echo '<div class="well row-fluid btn-toolbar" id="einsatzarten_panel">'.$catbox.'</div>';?>
  ...
  <div class="row-fluid">
<div class="well eiko_gmap_sidebar span6" id="side_bar" style="height: <?php echo $gmapconfig->gmap_height;?>px"></div>
<div class="well eiko_gmap_map well span6" id="map" style="height: <?php echo $gmapconfig->gmap_height;?>px"></div>
</div>
